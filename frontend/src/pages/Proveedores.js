...
function fetchProveedores() {
    return __awaiter(this, void 0, void 0, function* () {
        ...
        const response = yield fetch('http://localhost:3000/providers', {
            method: 'GET',
            headers: {
...
export default function Proveedores() {
    ...
    return (React.createElement("div", { className: "bg-background min-h-screen py-8" },
        React.createElement("div", { className: "container mx-auto px-4" },
            ...
            React.createElement("div", { className: "grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6" }, proveedores.map((proveedor) => (React.createElement(Card, { key: proveedor.id, className: "overflow-hidden shadow-md hover:shadow-lg transition-shadow duration-200" },
