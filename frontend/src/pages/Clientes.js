        ...
        return __generator(this, function (_a) {
            switch (_a.label) {
                case 0:
                    ...
                    return [4 /*yield*/, fetch('http://localhost:3000/clients', {
                            method: 'GET',
                            headers: {
...
export default function Clientes() {
    var _a = useState([]), clientes = _a[0], setClientes = _a[1];
    var _b = useState(true), loading = _b[0], setLoading = _b[1];
    var _c = useState(null), error = _c[0], setError = _c[1];
    useEffect(function () {
        fetchClientes()
            .then(setClientes)
            .catch(function () { return setError('Error al cargar los clientes'); })
    ...
    return (React.createElement("div", { className: "bg-background min-h-screen py-8" },
        React.createElement("div", { className: "container mx-auto px-4" },
            ...
            React.createElement("div", { className: "grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6" }, clientes.map(function (cliente, index) { return (React.createElement(Card, { key: index, className: "border border-muted shadow-sm hover:shadow-md transition-shadow duration-200" },
